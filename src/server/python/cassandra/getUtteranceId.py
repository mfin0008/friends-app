...
if __name__ == "__main__":
    ...
    result = session.execute(f"select utterance_id from utterances_by_id where season = {season_number} and episode = {episode_number} and scene = {scene_number} and utterance = {utterance_number};").one()
    print(result[0])